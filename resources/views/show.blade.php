...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex"> 
            <img src="https://image.tmdb.org/t/p/original/{{ $movie['poster_path'] }}" alt="parasite" class="w-96" style="width: 24rem;">
            <div class="ml-24">
                ...
                <div class="mt-12">
                    <a href="https://www.youtube.com/watch?v={{ $trailer }}" target="_blank" class="inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold
            ...
            <div class="flex justify-center gap-7">  
                @foreach ( $movie['credits']['cast'] as $cast)
                    @if ($loop->index < 5)
                        <div class="mt-8">
                                <a href="#">
                                    <img src="https://image.tmdb.org/t/p/original/{{ $cast['profile_path'] }}" alt="parasite" class="w-40 hover:opacity-75 transition-opacity">
                                </a>
                                <div class="mt-2">
